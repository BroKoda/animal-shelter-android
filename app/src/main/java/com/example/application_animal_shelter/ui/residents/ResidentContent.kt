...
object ResidentContent {
    ...
    private fun createPlaceholderItem(position: Int): PlaceholderItem {
        return PlaceholderItem(position.toString(), "Resident $position", "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus dignissim.", "2023.05.$position")
    }
